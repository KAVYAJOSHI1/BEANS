...
| | |
|---|---|
| Fused risk PR-AUC (random = 0.066) | **0.967**; without network-layer features 0.902 |
| Alerts that are illicit / illicit entities alerted | **99.7 %** / 83 % |
| E3 transaction-shape classifier macro-F1 | 0.993 |
| Calibration error (ECE) | 0.009 |
| End-to-end run (ingest + 4 engines + training) | 16 s on a laptop |
